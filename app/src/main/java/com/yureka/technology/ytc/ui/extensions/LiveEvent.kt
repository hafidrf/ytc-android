package com.yureka.technology.ytc.ui.extensions
...
/**
 * Single event live data that is intended to be used only once. For yureka SnackBar, Navigation and other events.
