package com.yureka.technology.ytc.util.android;
...
public class FButton extends AppCompatButton implements View.OnTouchListener {
    ...
    private void init() {
        ...
        mButtonColorDisabled = resources.getColor(R.color.colorButtonDisabled);
    ...
    public void refresh() {
        ...
        if (this.isEnabled()) {
            ...
            int disabledColor = mShadowColor = mButtonColorDisabled;
