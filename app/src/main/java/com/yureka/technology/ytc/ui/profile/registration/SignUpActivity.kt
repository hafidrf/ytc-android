...
@AndroidEntryPoint
class SignUpActivity : BaseActivity<LayoutSignUpV2Binding>() {
...
//        binding.edUsiaSignUp.setOnFocusChangeListener { v, hasFocus ->
//            binding.scrollNested.smoothScrollTo(0, v.getYPosition(this, binding.root),500)
//        }
